...
Use this directory to build and install the AMD64 AuroWork package locally on Arch Linux without Docker.

## What this packaging does

- Targets `x86_64` Arch Linux.
- Downloads the published GitHub release asset `aurowork-desktop-linux-amd64.deb`.
...
2. build an Arch package such as `aurowork-<version>-1-x86_64.pkg.tar.zst`
...
```bash
sudo pacman -U aurowork-<version>-1-x86_64.pkg.tar.zst
```
