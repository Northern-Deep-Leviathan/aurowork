...
const starterRoot = "/Users/test/AuroWork/starter";
const otherRoot = "/Users/test/AuroWork/second";
...
try {
  ...
  await step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\AuroWork\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\AuroWork\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\AuroWork\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/aurowork/starter");
  });
