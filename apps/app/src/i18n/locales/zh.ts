...
export default {
  ...
  "settings.developer_mode_description": "显示包含诊断和恢复工具的调试标签页。重启应用后会重置。",
  ...
  "settings.launch_diag_title": "启动日志",
  "settings.launch_diag_description": "开发者模式开启时，每次启动都会自动记录完整的启动日志（shell / ui / orchestr / engine / server 五个阶段）。重启应用即可生成新的一份。",
  "settings.launch_diag_run": "重启应用",
  "settings.launch_diag_run_hint": "（重启后会生成新的启动日志）",
  "settings.launch_diag_running": "正在重启……",
  "settings.launch_diag_confirm": "这将重启 AuroWork，正在进行的任务可能丢失。是否继续？",
  "settings.launch_diag_last": "上次启动日志",
  "settings.launch_diag_none": "暂无启动日志。",
  "settings.launch_diag_open_folder": "打开日志文件夹",
  "settings.launch_diag_copy_path": "复制路径",
  "settings.launch_diag_toast_title": "已生成启动日志",
