 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, AuroWork) NÃO são traduzidos
 */
...
export default {
  ...
  "dashboard.hero_description": "Descreva um resultado. O AuroWork vai executar e manter um histórico de auditoria.",
  ...
  "share_skill_destination.connect_remote_desc": "Vincular um host AuroWork e selecioná-lo na lista para importar esta skill.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor AuroWork como workspace.",
  "dashboard.create_remote_workspace_confirm": "Adicionar Workspace",
  "dashboard.edit_remote_workspace_title": "Editar Conexão Remota",
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor AuroWork para este workspace.",
  "dashboard.edit_remote_workspace_confirm": "Salvar conexão",
  "dashboard.remote_workspace_title": "Workspace remoto",
  "dashboard.remote_workspace_hint": "Acompanhe um servidor AuroWork e reconecte a qualquer momento.",
  "dashboard.remote_base_url_label": "URL do servidor AuroWork",
  ...
  "dashboard.aurowork_host_label": "URL do servidor AuroWork",
  "dashboard.aurowork_host_placeholder": "https://seu-servidor.aurowork.app",
  "dashboard.aurowork_host_hint": "Use a URL fornecida pelo seu servidor AuroWork.",
  "dashboard.aurowork_host_token_label": "Token de colaborador ou proprietário",
  "dashboard.aurowork_host_token_placeholder": "Cole seu token",
  "dashboard.aurowork_host_token_hint": "Opcional. Cole um token de colaborador para acesso rotineiro ou um token de proprietário quando este cliente precisar responder a prompts de permissão.",
  "dashboard.remote_mode_aurowork_alpha": "Servidor AuroWork",
  ...
  "session.placeholder": "Pergunte ao AuroWork...",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor AuroWork conectado.",
  ...
  "skills.connect_host_to_load": "Conecte um servidor AuroWork para carregar skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o AuroWork as use em seu nome.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Conecte apps para expandir o que o AuroWork pode fazer.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Conecte apps para expandir o que o AuroWork pode fazer.",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo AuroWork.",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o AuroWork precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  ...
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o AuroWork precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o AuroWork",
  ...
  "settings.updates_description": "Manter o AuroWork atualizado.",
  ...
  "settings.advanced_description": "Redefinir estado local do AuroWork para retestar o onboarding.",
  "settings.reset_onboarding": "Redefinir onboarding",
  "settings.reset_onboarding_description": "Apaga as preferências do AuroWork e reinicia o app.",
  "settings.reset_app_data": "Redefinir dados do app",
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do AuroWork.",
  ...
  "settings.reset_confirmation_hint": "Digite <span class=\"font-mono\">RESET</span> para confirmar. O AuroWork será reiniciado.",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no AuroWork.",
  "settings.reset_app_data_warning": "Apaga cache e dados do AuroWork neste dispositivo.",
  ...
  "settings.updates_hint": "Manter o AuroWork atualizado.",
  ...
  "settings.advanced_hint": "Redefinir estado local do AuroWork para retestar o onboarding.",
  "settings.reset_onboarding_label": "Redefinir onboarding",
  "settings.reset_onboarding_hint": "Apaga as preferências do AuroWork e reinicia o app.",
  "settings.reset_app_data_label": "Redefinir dados do app",
  "settings.reset_app_data_hint": "Mais agressivo. Apaga cache + dados do AuroWork.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Iniciando servidor AuroWork...",
  "onboarding.searching_host": "Conectando ao servidor AuroWork...",
  ...
  "onboarding.start": "Iniciar AuroWork",
  ...
  "onboarding.windows_install_instruction": "Instale o OpenCode para Windows e reinicie o AuroWork. Certifique-se de que opencode.exe está no PATH.",
  ...
  "onboarding.cli_install_commands": "Instale o OpenCode com um dos comandos abaixo e reinicie o AuroWork.",
  ...
  "onboarding.remote_workspace_title": "Conectar ao servidor AuroWork",
  "onboarding.remote_workspace_description": "Conecte-se a um servidor AuroWork para acessar um workspace de qualquer lugar.",
  "onboarding.remote_workspace_action": "Conectar",
  "onboarding.remote_workspace_card_title": "Conectar um workspace remoto",
  "onboarding.remote_workspace_card_description": "Conecte-se a um servidor AuroWork para acessar um workspace compartilhado.",
  "onboarding.advanced_aurowork_host": "Servidor AuroWork",
  "onboarding.advanced_aurowork_hint": "Use uma URL de servidor e token de acesso para acesso compartilhado.",
  ...
  "onboarding.welcome_title": "Como você quer executar o AuroWork hoje?",
  "onboarding.run_local": "Executar localmente",
  "onboarding.run_local_description": "O AuroWork executa o OpenCode localmente e mantém seu trabalho privado.",
  ...
  "app.migration.restart_failed": "Migração concluída, mas o AuroWork não conseguiu reiniciar o engine local.",
