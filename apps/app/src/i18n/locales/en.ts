...
export default {
  ...
  "settings.launch_diag_title": "Launch log",
  "settings.launch_diag_description": "While Developer Mode is on, every launch records a full startup log (shell / ui / orchestr / engine / server). Restart the app to produce a fresh one.",
  "settings.launch_diag_run": "Restart app",
  "settings.launch_diag_run_hint": "(captures a new launch log)",
  "settings.launch_diag_running": "Restarting...",
  "settings.launch_diag_confirm": "This will restart AuroWork. Any in-progress work may be lost. Continue?",
  "settings.launch_diag_last": "Last launch log",
  "settings.launch_diag_none": "No launch log yet.",
  "settings.launch_diag_open_folder": "Open log folder",
  "settings.launch_diag_copy_path": "Copy path",
  "settings.launch_diag_toast_title": "Launch log captured",
