...
export default {
  ...
  "dashboard.hero_description": "何でも依頼してください。AuroWorkが実行し、すべて記録に残します。",
  ...
  "share_skill_destination.connect_remote_desc": "AuroWorkホストを接続し、リストから選択してこのスキルをインポートします。",
  ...
  "dashboard.create_remote_workspace_subtitle": "AuroWorkサーバーをワーカーとして保存します。",
  "dashboard.create_remote_workspace_confirm": "ワーカーを追加",
  "dashboard.edit_remote_workspace_title": "リモート接続を編集",
  "dashboard.edit_remote_workspace_subtitle": "このワーカーのAuroWorkサーバー詳細を更新します。",
  "dashboard.edit_remote_workspace_confirm": "接続を保存",
  "dashboard.remote_workspace_title": "リモートワーカー",
  "dashboard.remote_workspace_hint": "AuroWorkサーバーを登録して、いつでも再接続できます。",
  "dashboard.remote_base_url_label": "AuroWorkサーバーURL",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:<port>",
  "dashboard.remote_base_url_required": "続行するにはサーバーURLを追加してください。",
  "dashboard.aurowork_host_label": "AuroWorkサーバーURL",
  "dashboard.aurowork_host_placeholder": "https://your-server.aurowork.app",
  "dashboard.aurowork_host_hint": "AuroWorkサーバーから共有されたURLを使用してください。",
  "dashboard.aurowork_host_token_label": "アクセストークン",
  "dashboard.aurowork_host_token_placeholder": "トークンを貼り付け",
  "dashboard.aurowork_host_token_hint": "任意。サーバーからのアクセストークンを貼り付けて認証します。",
  "dashboard.remote_mode_aurowork_alpha": "AuroWorkサーバー",
  ...
  "session.placeholder": "AuroWorkに質問...",
  "session.run": "実行",
  ...
  "skills.host_only_error": "スキル管理にはローカルワーカーまたは接続されたAuroWorkサーバーが必要です。",
  ...
  "skills.connect_host_to_load": "スキルを読み込むにはAuroWorkサーバーに接続してください。",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "アプリ",
  "mcp.apps_subtitle": "ツールを接続して、AuroWorkが代わりに操作できるようにしましょう。",
  ...
  "mcp.mcps_title": "アプリ",
  "mcp.connect_mcp_hint": "アプリを接続してAuroWorkの機能を拡張しましょう。",
  ...
  "mcp.mcps_label": "アプリ",
  "mcp.mcps_description": "アプリを接続してAuroWorkの機能を拡張しましょう。",
  "mcp.configured": "設定済み",
  "mcp.updated": "同期済み",
  ...
  "mcp.login_unavailable": "このアプリはAuroWorkからのサインインに対応していません。",
  ...
  "mcp.auth.reload_notice": "この変更を反映するには、AuroWorkがワーカーサービスを更新する必要があります。実行中のセッションが中断される可能性があります。",
  "mcp.auth.reload_blocked": "セッション実行中はリロードが一時停止されます。セットアップを完了するには実行を停止してください。",
  "mcp.auth.reload_remote_confirm": "この変更を反映するには、AuroWorkがワーカーサービスを更新する必要があります。実行中のセッションが停止する可能性があります。続行しますか？",
  ...
  "mcp.auth.step2_title": "AuroWorkを承認",
  ...
  "settings.updates_description": "AuroWorkを最新の状態に保ちます。",
  ...
  "settings.advanced_description": "初期設定をやり直すためにAuroWorkのローカル状態をリセットします。",
  "settings.reset_onboarding": "オンボーディングをリセット",
  "settings.reset_onboarding_description": "AuroWorkの設定をクリアしてアプリを再起動します。",
  "settings.reset_app_data": "アプリデータをリセット",
  "settings.reset_app_data_description": "より強力なリセット。AuroWorkのキャッシュとアプリデータをクリアします。",
  "settings.reset": "リセット",
  ...
  "settings.reset_confirmation_hint": "確認のため <span class=\"font-mono\">RESET</span> と入力してください。AuroWorkが再起動されます。",
  "settings.reset_onboarding_warning": "AuroWorkのローカル設定とワーカーのオンボーディングマーカーをクリアします。",
  "settings.reset_app_data_warning": "このデバイスのAuroWorkキャッシュとアプリデータをクリアします。",
  ...
  "settings.updates_hint": "AuroWorkを最新の状態に保ちます。",
  ...
  "settings.advanced_hint": "初期設定をやり直すためにAuroWorkのローカル状態をリセットします。",
  "settings.reset_onboarding_label": "オンボーディングをリセット",
  "settings.reset_onboarding_hint": "AuroWorkの設定をクリアしてアプリを再起動します。",
  "settings.reset_app_data_label": "アプリデータをリセット",
  "settings.reset_app_data_hint": "より強力なリセット。AuroWorkのキャッシュとアプリデータをクリアします。",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "AuroWorkサーバーを起動中...",
  "onboarding.searching_host": "AuroWorkサーバーに接続中...",
  ...
  "onboarding.windows_install_instruction": "Windows版OpenCodeをインストールしてからAuroWorkを再起動してください。opencode.exeがPATHにあることを確認してください。",
  ...
  "onboarding.cli_install_commands": "以下のコマンドでOpenCodeをインストールしてからAuroWorkを再起動してください。",
  ...
  "onboarding.remote_workspace_title": "AuroWorkサーバーに接続",
  "onboarding.remote_workspace_description": "AuroWorkサーバーに接続して、どこからでもワーカーにアクセスできます。",
  "onboarding.remote_workspace_action": "接続",
  "onboarding.remote_workspace_card_title": "リモートワーカーに接続",
  "onboarding.remote_workspace_card_description": "AuroWorkサーバーに接続して共有ワーカーにアクセスします。",
  "onboarding.advanced_aurowork_host": "AuroWorkサーバー",
  "onboarding.advanced_aurowork_hint": "共有アクセス用にサーバーURLとアクセストークンを使用します。",
  ...
  "onboarding.welcome_title": "今日のAuroWorkの使い方は？",
  "onboarding.run_local": "ローカルで実行",
  "onboarding.run_local_description": "AuroWorkはOpenCodeをローカルで実行し、作業をプライベートに保ちます。",
  ...
  "app.migration.unsupported": "このOpenCodeバイナリは `opencode db migrate` をサポートしていません。AuroWorkで固定しているOpenCodeバージョンへ更新するか、バンドルされたエンジンに切り替えてください。",
  "app.migration.failed": "OpenCodeのマイグレーションに失敗しました。",
  "app.migration.restart_failed": "マイグレーションは完了しましたが、AuroWorkがローカルエンジンを再起動できませんでした。",
