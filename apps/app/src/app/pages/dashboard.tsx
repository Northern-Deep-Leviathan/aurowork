...
export default function DashboardView(props: DashboardViewProps) {
  ...
  const openConfig = () => {
    props.setTab(props.developerMode ? "config" : "settings");
  };
  ...
  const [shareLocalAuroworkWorkspaceId, setShareLocalAuroworkWorkspaceId] = createSignal<string | null>(null);
          ...
          <Switch>
            ...
            <Match when={props.tab === "config" && props.developerMode}>
              <ConfigView
                ...
                auroworkServerUrl={props.auroworkServerUrl}
                auroworkServerSettings={props.auroworkServerSettings}
                auroworkServerHostInfo={props.auroworkServerHostInfo}
                runtimeWorkspaceId={props.runtimeWorkspaceId}
                updateAuroworkServerSettings={props.updateAuroworkServerSettings}
                resetAuroworkServerSettings={props.resetAuroworkServerSettings}
                testAuroworkServerConnection={props.testAuroworkServerConnection}
            ...
            <Match when={props.tab === "settings"}>
              <SettingsView
                  ...
                  auroworkServerStatus={props.auroworkServerStatus}
                  auroworkServerUrl={props.auroworkServerUrl}
                  auroworkServerClient={props.auroworkServerClient}
                  auroworkReconnectBusy={props.auroworkReconnectBusy}
                  reconnectAuroworkServer={props.reconnectAuroworkServer}
                  auroworkServerSettings={props.auroworkServerSettings}
                  auroworkServerHostInfo={props.auroworkServerHostInfo}
                  auroworkServerCapabilities={props.auroworkServerCapabilities}
                  auroworkServerDiagnostics={props.auroworkServerDiagnostics}
                  runtimeWorkspaceId={props.runtimeWorkspaceId}
                  selectedWorkspaceRoot={props.selectedWorkspaceRoot}
                  ...
                  cleanupAuroworkDockerContainers={props.cleanupAuroworkDockerContainers}
