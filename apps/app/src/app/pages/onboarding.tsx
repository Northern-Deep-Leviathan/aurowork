          ...
          <div class="max-w-md w-full z-10 space-y-8">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-4">
                ...
                />
                <label class="block">
                  <div class="mb-1 text-xs font-medium text-gray-11">{translate("dashboard.aurowork_host_token_label")}</div>
                  ...
                  <div class="mt-1 text-xs text-gray-10">{translate("dashboard.aurowork_host_token_hint")}</div>
                </label>
                <TextInput
          ...
          <div class="max-w-xl w-full z-10 space-y-12">
            <div class="text-center space-y-4">
              <div class="flex items-center justify-center gap-3 mb-6">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-gray-12">AuroWork</h1>
              </div>
