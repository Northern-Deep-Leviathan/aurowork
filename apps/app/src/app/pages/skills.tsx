...
const AUROWORK_DEFAULT_SKILL_NAMES = new Set([
  "workspace-guide",
  "get-started",
  "skill-creator",
  "command-creator",
...
export default function SkillsView(props: SkillsViewProps) {
  ...
  const publishShareLink = async () => {
    ...
    try {
      ...
      const result = await publishAuroworkBundleJson({
        payload,
        bundleType: "skill",
        name: target.name,
      });
    ...
    try {
      ...
      try {
        ...
        if (schemaVersion !== 1 || type !== "skill") {
          throw new Error("This link is not an AuroWork skill bundle");
        }
  ...
  const isAuroworkInjectedSkill = (skill: SkillCard) => {
    ...
    return AUROWORK_DEFAULT_SKILL_NAMES.has(normalizedName) || normalizedName.endsWith("-creator");
  };
  ...
  return (
    <section class="space-y-8">
      ...
      <div class="rounded-2xl border border-dls-border bg-dls-surface px-5 py-5 shadow-[0_8px_26px_rgba(17,24,39,0.05)]">
        ...
        <div class="mt-4 grid grid-cols-2 gap-3 md:grid-cols-2">
                  ...
                  <div class="flex gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                      <div class="flex items-center gap-2 mb-0.5">
                        ...
                        <Show when={isAuroworkInjectedSkill(skill)}>
          ...
          <div class="bg-dls-surface border border-dls-border w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
            <div class="p-6 space-y-4">
              ...
              <div class="rounded-xl border border-dls-border bg-dls-hover px-4 py-3 text-xs text-dls-secondary">
                ...
                <div class="mt-1 font-mono break-all">Publisher: {DEFAULT_AUROWORK_PUBLISHER_BASE_URL}</div>
              </div>
      ...
      {/* Custom repo modal hidden — part of Skill Hub feature. See .claude/plans/skill-hub-hidden.md */}
    </section>
  );
}
