...
Try browser automation in AuroWork right away.
...
- Instead, tell the user the shortest exact steps to connect `Control Chrome` from AuroWork's MCP tab, then ask them to retry.
