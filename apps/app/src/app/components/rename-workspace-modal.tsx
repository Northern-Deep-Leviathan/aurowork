        ...
        <div class="bg-dls-surface border border-dls-border w-full max-w-lg rounded-3xl shadow-[var(--dls-shell-shadow)] overflow-hidden">
          <div class="p-6">
            <div class="flex items-start justify-between gap-4">
              <div>
                <h3 class="text-lg font-semibold text-dls-text">{translate("workspace.rename_title")}</h3>
                <p class="text-sm text-dls-secondary mt-1">{translate("workspace.rename_description")}</p>
              </div>
