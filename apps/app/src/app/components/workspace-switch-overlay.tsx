...
import AuroWorkLogo from "./aurowork-logo";
...
export default function WorkspaceSwitchOverlay(props: {
  ...
  return (
    <Show when={props.open}>
      <div class="fixed inset-0 z-[60] overflow-hidden bg-dls-surface text-dls-text motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300">
        <div class="absolute inset-0">
          <div class="absolute inset-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-dls-hover via-dls-surface to-dls-surface opacity-80" />
          <div
          ...
          />
          <div class="absolute inset-x-0 bottom-0 h-48 bg-gradient-to-t from-dls-surface via-dls-surface/40 to-transparent" />
        </div>
        ...
        <div class="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-10 text-center">
          <div class="flex flex-col items-center gap-8">
              ...
              <div class="relative h-24 w-24 flex items-center justify-center">
                <AuroWorkLogo size={44} class="drop-shadow-sm" />
              </div>
            </div>
            ...
            <div class="flex flex-col items-center gap-3">
              ...
              <div class="h-1 w-56 overflow-hidden rounded-full bg-dls-active/50">
