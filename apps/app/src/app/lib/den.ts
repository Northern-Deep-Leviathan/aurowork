...
import { isDesktopDeployment } from "./aurowork-deployment";
import { isTauriRuntime } from "../utils";

const STORAGE_BASE_URL = "aurowork.den.baseUrl";
const STORAGE_API_BASE_URL = "aurowork.den.apiBaseUrl";
const STORAGE_AUTH_TOKEN = "aurowork.den.authToken";
const STORAGE_ACTIVE_ORG_ID = "aurowork.den.activeOrgId";
const STORAGE_ACTIVE_ORG_SLUG = "aurowork.den.activeOrgSlug";
const STORAGE_ACTIVE_ORG_NAME = "aurowork.den.activeOrgName";
const DEFAULT_DEN_TIMEOUT_MS = 12_000;

export const DEFAULT_DEN_AUTH_NAME = "AuroWork User";
...
export function buildDenAuthUrl(baseUrl: string, mode: "sign-in" | "sign-up"): string {
  ...
  if (isDesktopDeployment()) {
    ...
    target.searchParams.set("desktopScheme", "aurowork");
  }
...
function getWorkerTokens(payload: unknown): DenWorkerTokens | null {
  ...
  return {
    ...
    auroworkUrl: connect && typeof connect.auroworkUrl === "string" ? connect.auroworkUrl : null,
