...
const serverBin = resolve(root, "..", "server", "dist", "bin", "aurowork-server");
...
await copyFile(serverBin, resolve(targetDir, "aurowork-server"));
...
const versions = {
  "aurowork-server": {
    ...
    sha256: await sha256(resolve(targetDir, "aurowork-server")),
  },
  "opencode-router": {
