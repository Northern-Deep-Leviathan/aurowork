...
const binaryName = process.platform === "win32" ? "aurowork-server.exe" : "aurowork-server";
...
console.error(
  `Unable to find an AuroWork server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
