...
const env = {
  ...process.env,
  ...windowsBuildEnv,
  AUROWORK_DEV_MODE: process.env.AUROWORK_DEV_MODE || "1",
  AUROWORK_DATA_DIR:
    process.env.AUROWORK_DATA_DIR ||
    `${homedir()}${process.platform === "win32" ? "\\" : "/"}.aurowork${process.platform === "win32" ? "\\" : "/"}aurowork-orchestrator-dev`,
  AUROWORK_USE_COREPACK_PNPM: "1",
