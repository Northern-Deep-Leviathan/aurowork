...
pub const AUROWORK_PORT_RANGE_START: u16 = 48_000;
pub const AUROWORK_PORT_RANGE_END: u16 = 51_000;
...
fn range_port_count() -> usize {
    usize::from(AUROWORK_PORT_RANGE_END - AUROWORK_PORT_RANGE_START) + 1
}
...
pub fn resolve_aurowork_port(
    ...
    for step in 0..count {
        ...
        let port = AUROWORK_PORT_RANGE_START + u16::try_from(index).unwrap_or(0);
