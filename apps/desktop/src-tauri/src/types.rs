...
pub struct WorkspaceAuroworkConfig {
    pub version: u32,
    pub workspace: Option<WorkspaceAuroworkWorkspace>,
    #[serde(default, alias = "authorizedRoots")]
    pub authorized_roots: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reload: Option<WorkspaceAuroworkReload>,
}

impl Default for WorkspaceAuroworkConfig {
    fn default() -> Self {
        Self {
            version: 1,
            workspace: None,
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct WorkspaceAuroworkReload {
...
#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub struct WorkspaceAuroworkWorkspace {
...
impl WorkspaceAuroworkConfig {
    pub fn new(workspace_path: &str, preset: &str, now_ms: u64) -> Self {
        ...
        Self {
            version: 1,
            workspace: Some(WorkspaceAuroworkWorkspace {
