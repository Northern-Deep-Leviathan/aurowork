...
export const metadata: Metadata = {
  metadataBase: new URL("https://app.auroworklabs.com"),
  title: "Den Cloud Workers",
  description:
    "Launch AuroWork cloud workers, manage Polar checkout flows, and run Den from app.auroworklabs.com with the same positioning as the landing page.",
  openGraph: {
    title: "Den Cloud Workers",
    description:
      "Always-on AI workers for you and your team, launched from app.auroworklabs.com.",
  ...
  twitter: {
    ...
    title: "Den Cloud Workers",
    description:
      "Launch AuroWork cloud workers, manage Polar checkout flows, and operate Den from app.auroworklabs.com.",
    images: ["/opengraph-image"]
  },
  icons: {
    icon: "/aurowork-mark.svg"
  }
};
