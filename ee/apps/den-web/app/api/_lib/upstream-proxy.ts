...
const DEFAULT_API_BASE = "https://api.auroworklabs.com";
const DEFAULT_AUTH_ORIGIN = "https://app.auroworklabs.com";
const DEFAULT_AUTH_FALLBACK_BASE = "https://den-control-plane-aurowork.onrender.com";
