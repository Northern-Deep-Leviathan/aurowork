        ...
        <div className="grid gap-6 rounded-[32px] border border-white/70 bg-white/92 p-5 shadow-[0_28px_80px_-44px_rgba(15,23,42,0.35)] backdrop-blur md:p-6">
          <div className="grid gap-3 text-center">
            <h1 className="text-[2rem] font-semibold leading-[1.02] tracking-[-0.045em] text-[var(--dls-text-primary)] md:text-[2.5rem]">
              {verificationRequired
                ...
                : authMode === "sign-up"
                  ? "Create your AuroWork Den account."
                  : "Sign in to AuroWork Den."}
            </h1>
          ...
          {desktopAuthRequested ? (
            <div className="rounded-[24px] border border-sky-200 bg-sky-50/80 px-4 py-3 text-sm text-sky-900">
              Finish auth here and we&apos;ll bounce you back into the AuroWork desktop app automatically.
              {desktopRedirectUrl ? (
                <div className="mt-3 grid gap-3">
                  ...
                  <p className="text-xs leading-5 text-sky-900/80">
                    If AuroWork does not open automatically, copy the sign-in link or one-time code and paste it into AuroWork Cloud settings.
                  </p>
                </div>
              ) : null}
            </div>
