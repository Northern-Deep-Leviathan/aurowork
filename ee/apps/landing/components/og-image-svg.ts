    ...
    <svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(104 140)">
        <g transform="translate(0 0)">
          ...
          <text x="62" y="28" fill="#011627" font-family="Inter, Arial, sans-serif" font-size="36" font-weight="600">AuroWork</text>
        </g>
      ...
      <g transform="translate(620 122)">
        ...
        <text x="290" y="72" text-anchor="middle" fill="#6b7280" font-family="Inter, Arial, sans-serif" font-size="12" font-weight="500">AuroWork</text>
