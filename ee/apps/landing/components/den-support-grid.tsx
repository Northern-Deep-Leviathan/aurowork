    ...
    <section className="grid gap-6 md:grid-cols-2">
      ...
      <div className="flex flex-col gap-6">
        <div className="landing-shell flex flex-1 flex-col justify-center rounded-[2rem] p-6 md:p-8">
          ...
          <p className="leading-relaxed text-gray-600">
            Run and monitor the same workers from the AuroWork desktop app or directly inside your team chats.
          </p>
        </div>
        ...
        <div className="landing-shell flex flex-1 flex-col justify-center rounded-[2rem] p-6 md:p-8">
          ...
          <p className="leading-relaxed text-gray-600">
            Bring your existing AuroWork setup and everything is available immediately in each hosted worker.
          </p>
        </div>
      </div>
    </section>
