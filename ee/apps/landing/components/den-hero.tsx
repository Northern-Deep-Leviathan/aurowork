    ...
    <section className="pt-8 md:pt-14">
      <div className="max-w-[42rem]">
        ...
        <p className="mt-5 max-w-[35rem] text-lg leading-relaxed text-gray-700 md:text-[1rem] md:leading-8 lg:text-[1.02rem]">
          Cloud gives you a personal cloud workspace for long-running tasks, background automation, and the same agent workflows you already use locally in AuroWork, without keeping your own machine awake.
        </p>
