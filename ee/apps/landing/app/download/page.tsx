...
export const metadata = {
  title: "AuroWork - Download",
  description:
    "Download AuroWork desktop for macOS, Windows, and Linux. Includes AUR install instructions and direct package downloads.",
};
        ...
        <div className="content-max-width px-6">
          <div className="animate-fade-up">
            ...
            <p className="mb-4 max-w-3xl text-[17px] leading-relaxed text-gray-700">
              Install AuroWork on macOS, Windows, or Linux. Pick the package that
          ...
          <section id="windows" className="py-6">
            ...
            <p className="mb-6 text-[15px] text-gray-700">
              AuroWork for Windows is available as an x64 MSI installer.
            </p>
            <a
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="feature-card border-emerald-100 bg-white/90 ring-1 ring-emerald-100/60">
                ...
                <p className="mb-4 text-[14px] text-gray-600">
                  Install and keep AuroWork updated via the Arch User Repository.
                </p>
                <pre className="mono overflow-x-auto rounded-lg bg-gray-950 px-4 py-3 text-[13px] text-gray-100">
                  <code>yay -S aurowork</code>
                </pre>
                <p className="mt-3 text-[13px] text-gray-600">
                  Prefer paru? <span className="mono">paru -S aurowork</span>
                </p>
                <a
