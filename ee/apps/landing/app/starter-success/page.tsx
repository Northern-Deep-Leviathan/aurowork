...
export const metadata = {
  title: "AuroWork - Starter Success",
  description: "Thanks for pre-ordering AuroWork Team Starter.",
};
...
export default async function StarterSuccessPage() {
  ...
  const calHref = (() => {
    ...
    try {
      ...
      url.searchParams.set("notes", "Paid customer: AuroWork Team Starter (12 months). Priority onboarding requested.");
        ...
        <div className="content-max-width px-6">
          <section className="animate-fade-up">
            ...
            <p className="max-w-2xl text-[16px] leading-relaxed text-gray-700">
              You&apos;re on track for getting access to AuroWork Hosted in 7 days.
            </p>
          </section>
          ...
          <div className="mt-10 rounded-xl border border-gray-100 bg-white p-5 text-[13px] text-gray-500">
            AuroWork stays open source, runs in any environment, and works with
            any model.
          </div>
