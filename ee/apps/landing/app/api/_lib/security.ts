...
const defaultAllowedOrigins = [
  "https://auroworklabs.com",
  "https://www.auroworklabs.com",
  "https://aurowork.software",
  "https://www.aurowork.software",
  "http://localhost:3000",
  "http://127.0.0.1:3000",
  "http://localhost:3005",
  "http://127.0.0.1:3005",
...
const store = globalThis as typeof globalThis & {
  __auroworkLandingRateLimitStore?: Map<string, FixedWindowEntry>;
};

const rateLimitStore = store.__auroworkLandingRateLimitStore ?? new Map<string, FixedWindowEntry>();
store.__auroworkLandingRateLimitStore = rateLimitStore;
