...
import { AuroWorkMark } from "../../components/aurowork-mark";
import { SiteFooter } from "../../components/site-footer";

export const metadata = {
  title: "AuroWork - Feedback",
  description: "Send app feedback to the AuroWork team with prefilled runtime context.",
};
...
export default function FeedbackPage({ searchParams }: PageProps) {
  const prefill: AppFeedbackPrefill = {
    source: readSearchParam(searchParams, "source") || "aurowork-app",
      ...
      <div className="mx-auto max-w-5xl px-6 pb-20 pt-6 md:px-8 md:pt-8">
        <header className="mb-10 flex items-center justify-between gap-4">
          <Link href="/" className="inline-flex items-center gap-3 text-[#011627]">
            <AuroWorkMark className="h-[30px] w-[38px]" />
