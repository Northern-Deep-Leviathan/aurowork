...
1. Install deps from repo root:
   `pnpm install`
2. Run the app:
   `pnpm --filter @aurowork-ee/landing dev`
...
- `LOOPS_INTERNAL_FEEDBACK_EMAIL` - optional override for the internal feedback recipient (defaults to `team@auroworklabs.com`)
...
2. Build command: `pnpm --filter @aurowork-ee/landing build`
3. Output: `.next`
4. Start command: `pnpm --filter @aurowork-ee/landing start`
5. Enable Vercel BotID for the project so protected form routes can reject automated submissions.

### Self-hosted

1. Build: `pnpm --filter @aurowork-ee/landing build`
2. Start: `pnpm --filter @aurowork-ee/landing start`
