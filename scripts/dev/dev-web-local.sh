...
PROJECT_NAME="aurowork-web-local"
DEV_CMD=(pnpm --parallel --filter @aurowork-ee/den-controller --filter @aurowork-ee/den-web dev)
...
: "${DATABASE_URL:=mysql://root:password@127.0.0.1:3306/aurowork_den}"
...
pnpm --filter @aurowork-ee/den-controller db:migrate
