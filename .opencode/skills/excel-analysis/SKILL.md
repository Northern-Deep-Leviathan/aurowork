---
name: excel-analysis
description: Analyze spreadsheet files — classify layout, read content with the
  appropriate strategy, and present findings. Use when the user wants to
  analyze, understand, or extract information from an Excel file.
---
# Excel Analysis
