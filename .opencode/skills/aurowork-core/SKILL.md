---
name: aurowork-core
description: Core context and guardrails for AuroWork native app
---
...
- AuroWork must stay within OpenCode's tool surface; avoid inventing new capabilities.
...
```bash
git clone https://github.com/Northern-Deep-Leviathan/auro vendor/opencode
```
