...
description: Bridge between AuroWork UI and OpenCode runtime
---

## Overview

AuroWork communicates with OpenCode via three mechanisms:
...
AuroWork can register as an MCP server that OpenCode connects to.
...
### Use cases
- Real-time permission prompts surfaced in AuroWork UI.
- Streaming progress updates.
- Custom tools exposed from AuroWork (e.g., native file picker).
