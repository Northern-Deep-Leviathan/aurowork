...
description: Classify an Excel sheet's layout type as tabular, form, mixed, or
  sparse. Use when the user wants to identify/classify/categorize the layout of
  a sheet.
---
