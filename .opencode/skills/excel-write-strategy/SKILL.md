...
description: Orchestrate Excel writes efficiently — direct write for small data,
  code generation for large data. Use when the user wants to write data to an
  Excel file.
---
