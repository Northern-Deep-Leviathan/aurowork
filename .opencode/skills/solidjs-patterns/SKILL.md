...
description: SolidJS reactivity + UI state patterns for AuroWork
---

## Why this skill exists

AuroWork’s UI is SolidJS: it updates via **signals**, not React-style rerenders.
...
This skill captures the patterns we want to consistently use in AuroWork.
