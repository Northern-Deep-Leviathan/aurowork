...
description: "How to import an external skill to your workspace in Aurowork"
---

There are currently three direct ways to import an external skill.

1. Importing an existing skill with share.auroworklabs
2. Pasting a skill in share.auroworklabs, then importing it.
...
When you have an aurowork [Share URL](https://share.aurowork.software/b/01KKPSGYSGDRRWNTAACAMZY3PF), you just need to click `Open in Aurowork`

<Frame>
  ![Share page with Open in AuroWork button](/images/skill-import-share-page.png)
</Frame>
...
Once this is installed, Aurowork will prompt you to reload so that it can load the skill into your workspace.
...
## Pasting a skill in share.auroworklabs, then importing it.

In this case, you start at [the skills share page](https://share.aurowork.software/) without any skill. Paste or upload the skill there, and click on generate link:
