---
title: "AuroWork Link: Connecting you slack with your workspace"
description: "Learn how to connect your slack with your workspace"
---

In order to connect `slack` with your aurowork `workspace`, you will need the following:

1. Valid slack admin permissions to add an app
2. Create a simple slack app
3. Connect said slack app with your workspace

This is one of the most relevant and meaningful applications of Aurowork, and we use it daily ourselves.
